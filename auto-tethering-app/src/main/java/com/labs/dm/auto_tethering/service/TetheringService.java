...
public class TetheringService extends IntentService {
    ...
    private final String[] invents = {TETHERING, WIDGET, RESUME, EXIT, USB_ON, USB_OFF,
            BT_RESTORE, BT_CONNECTED, BT_DISCONNECTED, BT_SEARCH, TEMP_OVER, TEMP_BELOW};
    ...
    protected void onHandleIntent(Intent intent) {
        if (isServiceActivated()) {
            showNotification(getString(R.string.service_started), serviceHelper.isTetheringWiFi() ? R.drawable.app_on : R.drawable.app_off);
